-- Write a SQL script that creates a stored procedure ComputeOverallWeightedScoreForUser that computes and store the overall weighted score for a student
DELIMITER |
